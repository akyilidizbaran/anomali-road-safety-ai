...
| `docs/03_sistem_mimarisi` | Mobil-edge-backend-5G veri akışı, normal/kritik mod, hedef araç stratejisi |
| `docs/04_yapay_zeka` | Araç, takip, plaka, OCR, hız, şerit, sahne, cabin risk, risk skoru |
| `docs/05_veri_seti` | Görev bazlı veri seti, etiketleme, split, augmentation, veri yönetimi |
| `docs/06_mobil_uygulama` | Camera, Evidence, System, Settings ekran gereksinimleri |
