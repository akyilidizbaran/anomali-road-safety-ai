...
* Variantlar: `original, clahe` | upscale `3.0`
...
|---|---|---:|---:|---:|---:|---|---:|---:|
| fastplate | video_1.mp4 | 206 | 205 | 203 | 203 | 34TC8532 | 0.9901 | 6.078 |
| fastplate | video_2.mp4 | 201 | 197 | 194 | 194 | 34TC8532 | 0.9713 | 5.758 |
| fastplate | video_3.mp4 | 206 | 205 | 200 | 200 | 34TC8532 | 0.9113 | 5.182 |

## Ciktilar

* Summary JSON'ler: `models/benchmarks/artifacts/POCR-EXP-00X-*-summary.json`
* Manuel review seed CSV: `runs/plate_ocr/POCR-EXP-007-cct-xs-upscale3-clahe/manual_review_<engine>.csv`
