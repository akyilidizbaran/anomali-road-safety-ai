...
|---|---|---:|---:|---:|---:|---|---:|---:|
| fastplate | video_1.mp4 | 206 | 205 | 203 | 203 | 34TC8532 | 0.9903 | 1.92 |
| fastplate | video_2.mp4 | 201 | 197 | 193 | 193 | 34TC8532 | 0.9733 | 1.89 |
| fastplate | video_3.mp4 | 206 | 202 | 195 | 194 | 34TC8532 | 0.9052 | 1.642 |

## Ciktilar

* Summary JSON'ler: `models/benchmarks/artifacts/POCR-EXP-00X-*-summary.json`
* Manuel review seed CSV: `runs/plate_ocr/POCR-EXP-007-cct-xs-baseline-percrop/manual_review_<engine>.csv`
